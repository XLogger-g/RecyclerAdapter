...
// end itemSelected
    ...
    private void AddAssign(String titleassend, String descassend) {
        ...
        String assign_id=mDatabase.push().getKey();
        String id=mDatabase.push().getKey();
        AssignListdata listdata = new AssignListdata(assign_id,titleassend, descassend);
        userID = FirebaseAuth.getInstance().getCurrentUser().getUid();
        mDatabase.child("Users").child(userID).child("Notes").child(id).child("Assignments").child(assign_id).setValue(listdata).
