...
public class ClassworkActivity extends AppCompatActivity {
    ...
    List<AssignListdata> assignlist =new ArrayList<>();
    Context context;
...
//        final String id = mCurrentUser.getUid();
        ...
        databaseReference = firebaseDatabase.getReference().child("Users").child(userID).child("Notes").child(String.valueOf(id)).child("Assignments");
